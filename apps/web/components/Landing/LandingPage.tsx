    ...
    <>
      <Section className="flex flex-col gap-y-32 py-0 md:py-0">
        <Hero
          ...
          description="Fide is the standard for mapping facts, relationships, and why decisions are made."
        >
          <div className="dark:border-polar-700 dark:bg-polar-900/30 w-full max-w-2xl rounded-3xl border border-gray-200 bg-white/80 p-6 shadow-sm backdrop-blur-sm md:p-8">
